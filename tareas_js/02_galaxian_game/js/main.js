...
function Background() {
    ...
    this.draw =  function () {
        ...
        this.context.drawImage(imageRepository.background, this.x, this.y - this.canvasHeigth);

        //If the image scrolled off the screen, reset
        if (this.y >= this.canvasHeigth) 
            this.y = 0;
    };
}
...
function Game() {
    ...
    this.init = function() {
        ...
        if (this.bgCanvas.getContext) {
            ...
            this.backgroundAudio = new Audio("audio/kick_shock.wav");
            this.backgroundAudio.loop = true;
            this.backgroundAudio.volume = .25;
            this.backgroundAudio.load();

            this.gameOverAudio = new Audio("audio/game_over.wav");
